...
with open('input14.txt','r') as f:
    reactions = parse_input(f.read().split('\n'))
...
def part2(reactions):
    ...
    while low < high-1:
        ...
        if ensure(reactions, data, 'FUEL', mid):
            ...
            high = mid - 1
    return high if ensure(reactions, data, 'FUEL', mid) else low

print('Day 14, Part 1: {}'.format(part1(reactions)))
print('Day 14, Part 2: {}'.format(part2(reactions)))